...
-- --------------------------------------------------------
--
-- Table structure for table `attr_image`
--
DROP TABLE IF EXISTS `attr_image`;
CREATE TABLE IF NOT EXISTS `attr_image` (
  `attr_id` varchar(32) NOT NULL,
  `image_name` varchar(32) NOT NULL,
...
('e', 'st'	, 'stadium'		, 'Azteca-Stadium-Mexico-City-1024x682.jpg'),

('f', 'mo'	, 'movies',             'Auckland Civic Theatre.jpg'),
('f', 'ng'	, 'nature garden'	, '326350-svetik.jpg'),
('f', 'tp'	, 'theme park'		, 'Wet’nWild-Water-World-Queensland.jpg'),

('s', 'sm'	, 'shopping mall'	, 'usa-online-shopping-mall-723514.jpg'),
('s', 'df'	, 'duty free'		, 'duty-free-stores-discount-coupon.jpg'),
...
-- images in /data folder in webapp
INSERT INTO `attraction` (`main_id`, `sub_id`, `attr_id`, `attr_name`, `contact`, `price`,`description`, `date`) VALUES
...
-- image names to be announced.

INSERT INTO `attr_image` (`attr_id`, `image_name`) VALUES
('kkc'	, '1'),('kkc'	, '2'),('kkc'	, '3'),
('sb'	, '4'),('sb'	, '5'),('sb'	, '6'),
('nhs'	, '7'),('nhs'	, '8'),('nhs'	, '9'),

('oac'	, '10'),('oac'	, '11'),('oac'	, '12'),
('kcsg'	, '13'),('kcsg'	, '14'),('kcsg'	, '15'),
('cap'	, '16'),('cap'	, '17'),('cap'	, '18'),

('rosm'	, '19'),('rosm'	, '20'),('rosm'	, '21'),
('dfsg'	, '22'),('dfsg'	, '23'),('dfsg'	, '24'),
('vpm'	, '25'),('vpm'	, '26'),('vpm'	, '27'),

('wit'	, '28'),('wit'	, '29'),('wit'	, '30'),
('kwt'	, '31'),('kwt'	, '32'),('kwt'	, '33'),
('tv'	, '34'),('tv'	, '35'),('tv'	, '36'),

('ht'	, '37'),('ht'	, '38'),('ht'	, '39'),
('wnhwt', '40'),('wnhwt', '41'),('wnhwt', '42'),
('bhcw'	, '43'),('bhcw'	, '44'),('bhcw'	, '45');
